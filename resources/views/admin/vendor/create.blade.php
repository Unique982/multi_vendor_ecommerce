                 ...
                 @enderror
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="form-control  @error('status') is-invalid @enderror" value="{{ old('status') }}">
                            ...
                            <option value="pending" {{ old('status') ?'seleted':'' }}>Pending</option>
                            <option value="approved" {{ old('status') ?'seleted':'' }}>Approved</option>
                            <option value="suspended" {{ old('status') ?'seleted':'' }}>Suspended'</option>
                        </select>
